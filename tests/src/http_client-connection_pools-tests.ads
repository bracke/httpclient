...
package Http_Client.Connection_Pools.Tests is
   --  AUnit test-case package for Connection_Pools.
   --
   ...
   --  AUnit test case containing the registered Connection_Pools tests.
