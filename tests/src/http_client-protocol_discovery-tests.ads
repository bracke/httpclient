...
package Http_Client.Protocol_Discovery.Tests is
   --  AUnit test-case package for Protocol_Discovery.
   --
   ...
   --  AUnit test case containing the registered Protocol_Discovery tests.
