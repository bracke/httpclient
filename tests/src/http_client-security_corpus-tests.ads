...
package Http_Client.Security_Corpus.Tests is
   --  AUnit test-case package for Security_Corpus.
   --
   ...
   --  AUnit test case containing the registered Security_Corpus tests.
