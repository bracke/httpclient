...
procedure Git_Info_Refs_HTTP2_Buffered is
...
begin
   Config.Execution.Protocol_Policy := Http_Client.Clients.Prefer_HTTP_2;
   Config.Execution.TLS.HTTP2.Mode := Http_Client.HTTP2.HTTP2_Allowed;
   ...
   if Status = Http_Client.Errors.Ok then
      ...
      --  This buffered example is only a small protocol-selection shape.
      null;
   end if;
end Git_Info_Refs_HTTP2_Buffered;
