...
procedure Git_HTTPS_Proxy_CONNECT is
...
begin
   Proxy := Http_Client.Proxies.HTTP ("proxy.example.invalid", 8080);
   Status := Http_Client.Proxies.With_Proxy_Authorization (Proxy, "Basic cHJveHk6cGFzcw==", Proxy);
