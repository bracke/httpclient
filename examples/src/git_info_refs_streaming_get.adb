...
procedure Git_Info_Refs_Streaming_Get is
...
begin
   --  Compile-targeted example: the reserved .invalid URI is not used by release checks.
...
end Git_Info_Refs_Streaming_Get;
